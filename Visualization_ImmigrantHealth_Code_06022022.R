...
nis$healthhome <- as.factor(ifelse(nis$d112==1, 'Excellent', 
...
nis$healthhome <- factor(nis$healthhome, levels = c("Fair/Poor", "Good", "Very Good", "Excellent"))
...
nis$country<- factor(nis$country, levels = c("China", "El Salvador", "India", "Philippines", "Mexico"))
...
nis <- subset(nis, health!='Missing' & health!='NA' & 
                   ...
                   select=c(health, healthhome, country, niswgtsamp1))
